...
subprojects {
    ...
    aliucord {
        ...
        updateUrl.set("https://raw.githubusercontent.com/GreenpeaceKT/Aliucord-plugins/builds/updater.json")
        buildUrl.set("https://raw.githubusercontent.com/GreenpeaceKT/Aliucord-plugins/builds/%s.zip")
    }
